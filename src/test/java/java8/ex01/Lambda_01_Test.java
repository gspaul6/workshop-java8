...
public class Lambda_01_Test {
	...
	class PersonAdultePredicate implements PersonPredicate {
		@Override
	...
	public void test_filter_by_age() throws Exception {
		...
		PersonPredicate predicate = new PersonAdultePredicate();
		
		// TODO result ne doit contenir que des personnes adultes (age >= 18)
		List<Person> result = this.filter(personList, predicate);

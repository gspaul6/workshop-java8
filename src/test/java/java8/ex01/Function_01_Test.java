...
public class Function_01_Test {
	...
	private Function<Integer, Person> intToPerson = g -> {
		String first = "first_" + g;
		String last = "last_" + g;
		Integer age = g;
		String pass = "pass_" + g;
		Person p = new Person(first, last, age, pass);
	...
	private Function<Person, Account> personToAccount = q -> {
